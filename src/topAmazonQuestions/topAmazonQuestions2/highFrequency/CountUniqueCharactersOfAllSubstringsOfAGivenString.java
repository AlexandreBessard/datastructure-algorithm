...
public class CountUniqueCharactersOfAllSubstringsOfAGivenString {
    ...
    B: 1
    A: 1
    AB : 2 (2 unique letters in that specific string)
    BA : 2 (2 unique letters in that specific string)
    ABA : 1 (2 letters of A does not count because not unique character in that string only B is unique -> 1)
     */

    public static void main(String[] args) {
        //String s = "ABCBD";
        String s1 = "aa";
        var obj = new CountUniqueCharactersOfAllSubstringsOfAGivenString();
        System.out.println(obj.uniqueLetterStringII(s1));
    }
